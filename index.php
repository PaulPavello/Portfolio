...
<html>
	<head>
		...
		<meta property="og:title" content="Paweł Wołoszyn - Portfolio" />
		<meta property="og:url" content="http://www.p-woloszyn.slask.pl" /> 
		<meta property="og:site_name" content="Paweł Wołoszyn - Portfolio"/>
    	<meta property="og:type" content="website"/>
    	<meta property="og:image" content=""/>
		<link rel="stylesheet" type="text/css" href="style.css">
		<title>Paweł Wołoszyn - Portfolio</title>  
	...
	<body>
		<header id="menu">
			<div id="logo_text"><a href="#home">p-woloszyn.slask.pl</a></div>
			<div id="logo_fb"><a href="https://www.facebook.com/pawel.woloszyn1308" target="_blank">
        	<img src='img/facebook.png' height="45">
			</a></div>
			<div id="logo_li"><a href="http://www.linkedin.com/pub/pawe%C5%82-wo%C5%82oszyn/88/4a9/37" target="_blank">
        	<img src='img/linkedin.png' height="45">
			</a></div>
			<nav>
	            <ul class="fancyNav">
	                <li id="home"><a href="#home" class="homeIcon">Home</a></li>
	                <li id="about"><a href="#about">O Mnie</a></li>
	                <li id="projects"><a href="#projects">Projekty</a></li>
			...
			<section id="main_section">
				<div class="section active" id="section0">
					<h1>Witam!</h1>
					<p>Nazywam się Paweł Wołoszyn, jestem młodym i ambitnym inżynierem.
				...
				<div class="section" id="section2">
					...
					<h1>Paweł Wołoszyn</h1>
					<p>
					<img src='img/qr.png' height="250" align="left" style="margin-right: 10px; border-style: solid; border-color: #FFF; border-width: 5px;"/>
				...
				<div class="section" id="section3">
					...
					<h1>Aktualnie wykonuję</h1>
					<p>
					<ol>
					<li>Projekt sklepu internetowego wraz z panelem administracyjnym.</li>
					<li>Panel administracyjny dla strony parafialnej.</li>
					<li>Strona www firmy remontowej.</li>
					<li>...</li>
					<li><u>Jeżeli chcesz aby Twój projekt znalazł się tutaj - napisz do mnie za pomocą formularza w dziale kontakt.</u></li>
					</ol>
					</p>
					</div>
					<div class='slide' id="#projects">
					<h1>Gra Space Time</h1>
					<p>
					...
					<div class='slide' id="#projects">
					<h1>Gra Wind of Changes</h1>
					<img width="300" src="img/projects_photo/2.png">
					<p>
					...
					<div class='slide' id="#projects">
					<h1>Strona internetowa dla gry Wind of Changes</h1>
					<a href="http://www.windofchanges.comule.com" target="_blank"><img width="200" src="img/projects_photo/3.png"></a>
					<p>
					...
					<div class='slide' id="#projects">
					<h1>Opracowanie projektu platformy gier "RUTI Games"</h1>
					<img width="200" src="img/projects_photo/4.png">
					<p>
					...
					<div class='slide' id="#projects">
					<h1>Projekt serwisu "Powieść-Online.pl"</h1>
					<img width="200" src="img/projects_photo/7.png">
					<p>
					...
					<div class='slide' id="#projects">
					<h1>Wirtualna konsola DJ "DJConsole"</h1>
					<img width="300" src="img/projects_photo/5.png">
					<p>
					...
					<div class='slide' id="#projects">
					<h1>Projekt witryny dla parafii św. Maksymiliana Marii Kolbego w Szczerbicach</h1>
					<a href="http://parafia-szczerbice.rybnik.pl" target="_blank"><img width="300" src="img/projects_photo/6.png"></a>
					<p>
				...
				<div class="section" id="section5">
					...
					<label>Podaj maila: <input name='mail' type="email" required ></label><br/><br/>
					<label>Wpisz treść wiadomości:<br/>
					<textarea rows="10" cols="50" name='message' required ></textarea></label><br/>
					<label>
					<?php
          				include_once('re.php');
          				$publickey = "6LeQW-4SAAAAALOykvZsOXd50hPMgJAbvF9JQf4y ";
